...
mutate(scfa_total_median_mmol_kg=acetate_median+butyrate_median+propionate_median) %>% 
mutate(scfa_total_mean_mmol_kg=butyrate_mean+acetate_mean+propionate_mean) %>% 
rename(acetate_median_mmol_kg = acetate_median, 
                    butyrate_median_mmol_kg = butyrate_median,
                    propionate_median_mmol_kg = propionate_median) %>% 
