...
select(-acetate_median_mmol_kg,-butyrate_median_mmol_kg,-propionate_median_mmol_kg,-scfa_total_median_mmol_kg) %>% 
...
# covert columns to snake case 
  # has been done in the last HW
 
# add units to SCFA measurements 
  # Did the wrong unit last time
...
### With facets
We will use the code above as a template to create a scatter plot. 
...
> ** enter answer here ** 
No redundant y-axis
shorter code, easy to read and understand,
but hard to reset the colour 
...
Export plot 3.6 
```{r}
save_plot(filename = "figures/3_6.pdf",
          plot = plot3_6,
          nrow = 1, ncol = 2, 
          base_aspect_ratio = 1.1)
